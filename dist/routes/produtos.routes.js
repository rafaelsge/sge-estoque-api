 ...
 *                   nullable: true
 */
router.get('/search', produtos_controller_1.searchProduto);
/**
 * @swagger
 * /produtos/eans:
 *   get:
 ...
 */
router.post('/cadastrar', produtos_controller_1.cadastrarProduto);
/**
 * @swagger
 * /produtos/{id}:
 *   put:
 ...
 */
router.put('/:id', produtos_controller_1.atualizarProduto);
/**
 * @swagger
 * /produtos/{id}:
 *   delete:
 ...
 *         description: Produto não encontrado
 */
router.delete('/:id', produtos_controller_1.excluirProduto);
